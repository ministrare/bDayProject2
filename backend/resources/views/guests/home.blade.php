    ...
    <div class="main-body">
        ...
        <div class="invite-content">
            ...
            <div class="text-content-main">
                <p>
                    Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the Lorem Ipsum has been the industry's standard dummy text ever since the Lorem Ipsum has been the industry's
                    standard dummy text ever since the Lorem Ipsum has been the industry's standard dummy text ever since the
                </p>
            </div>
        ...
        <span class="blast-bd"><h2 class="big-italic text-white line-he">My Birthday with a blast!</h2> </span>
        <div class="playlist-box">
            ...
            <div class="fakeimg">
                ...
                <span> <a href="index.html">Create a playlist of your favorite songs </a> <img src="./images/Path 31.svg" width="20" height="20"> </a></span>
        ...
        <div class="bd-location-box">
            <span class="just-content"> <h2 class="big-italic text-white line-he lg-text">Drop your anchors!</h2> <h2 class="big-italic text-white line-he lg-text">And follow the map</h2>  </span>

            <div class="location-content">

                <div class="location-tent">
                    <span class="f-box f-box-label">Location</span>
                    <span class="f-box f-box-text">Corbie Hotel - Banquet Hall<br>
                                            Markt 14, Tessenderlo,
                                    </span><br>
